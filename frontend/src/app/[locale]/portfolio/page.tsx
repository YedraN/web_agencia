          ...
          <div className="mx-auto max-w-7xl px-6 sm:px-10">
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-5 auto-rows-[320px]">
              {projects.map((project, i) => {
                const descText = typeof project.desc === 'object' ? project.desc[locale as keyof typeof project.desc] || project.desc.es : project.desc;
                return (
                  <motion.div
                    key={project.title}
                    variants={fadeUp}
                  ...
                  >
                    ...
                    <div className="absolute bottom-0 left-0 right-0 p-6 z-10 bg-gradient-to-t from-black/70 to-transparent">
                      ...
                      <p className="text-sm text-white/55 leading-relaxed line-clamp-2">{descText}</p>
                    </div>
                  </motion.div>
                );
              })}
