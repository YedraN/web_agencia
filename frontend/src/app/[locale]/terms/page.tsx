...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    title: `${t("title")} | Vynta`,
    description: isEn
      ? "Vynta's terms of service — the terms governing the use of our services."
      : "Términos de servicio de Vynta — los términos que rigen el uso de nuestros servicios.",
    alternates: {
      canonical: isEn ? "https://vynta.dev/en/terms" : "https://vynta.dev/terms",
    },
  };
}
