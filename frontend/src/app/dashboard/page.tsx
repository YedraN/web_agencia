  ...
  return (
    <div className="flex-1 space-y-8">
      <div className="flex items-center justify-between space-y-2">
        <h2 className="text-3xl font-heading font-bold tracking-tight text-white">Client Overview</h2>
      </div>
          ...
          <>
            <Card className="bg-white/[0.02] border-white/5">
              ...
              <CardContent>
                ...
                <p className="text-xs text-white/40 mt-1">Both on schedule</p>
              </CardContent>
            </Card>
            
            <Card className="bg-white/[0.02] border-white/5">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-white/70">Total Invested (YTD)</CardTitle>
                <CreditCard className="h-4 w-4 text-white/50" />
              </CardHeader>
              <CardContent>
                <div className="text-3xl font-heading font-bold">${data?.totalSpent.toLocaleString()}</div>
                <p className="text-xs text-white/40 mt-1">+12% from previous year</p>
              </CardContent>
            </Card>
            
            <Card className="bg-white/[0.02] border-white/5">
              <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
                <CardTitle className="text-sm font-medium text-white/70">Next Milestone</CardTitle>
                <Clock className="h-4 w-4 text-white/50" />
              </CardHeader>
              <CardContent>
                <div className="text-xl font-heading font-bold mt-1">{data?.nextMilestoneDate}</div>
                <p className="text-xs text-white/40 mt-2">Design Handoff - Lumina App</p>
              </CardContent>
            </Card>
            ...
            <Card className={`bg-white/[0.02] border-white/5 ${data?.unreadInvoices && data.unreadInvoices > 0 ? "border-primary/50 relative overflow-hidden" : ""}`}>
              ...
              <CardContent className="relative z-10">
                ...
                <p className="text-xs text-white/40 mt-1">Action required</p>
              </CardContent>
            </Card>
          </>
        )}
      ...
      <div className="grid gap-6 md:grid-cols-2 lg:grid-cols-7 border border-white/5 rounded-2xl overflow-hidden bg-white/[0.01]">
          ...
          <div className="space-y-6 relative before:absolute before:inset-0 before:ml-5 before:-translate-x-px md:before:mx-auto md:before:translate-x-0 before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-white/10 before:to-transparent">
            ...
            <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group is-active">
              ...
              <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-4 rounded-xl border border-white/5 bg-white/[0.02]">
                <div className="flex items-center justify-between mb-1">
                  <span className="font-semibold text-white">UX Wireframes Approved</span>
                  <span className="text-xs text-white/40">Oct 02</span>
                </div>
                <p className="text-sm text-white/50">Lumina Commerce Redesign</p>
              </div>
            </div>
            ...
            <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
              ...
              <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-4 rounded-xl border border-white/5 bg-transparent">
                <div className="flex items-center justify-between mb-1">
                  <span className="font-semibold text-white/70">UI Design Handoff</span>
                  <span className="text-xs text-white/40">Oct 12</span>
                </div>
                <p className="text-sm text-white/40">High fidelity mockups delivery</p>
              </div>
            </div>
             ...
             <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group">
              ...
              <div className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-4 rounded-xl border border-white/5 bg-transparent">
                <div className="flex items-center justify-between mb-1">
                  <span className="font-semibold text-white/70">Engineering Sprint 1</span>
                  <span className="text-xs text-white/40">Nov 01</span>
                </div>
                <p className="text-sm text-white/40">Frontend architecture setup</p>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="col-span-full lg:col-span-3 p-8">
          <h3 className="text-xl font-heading font-bold tracking-tight mb-6">Recent Activity</h3>
          <div className="space-y-6">
            {[
              { title: "Invoice INV-0042 Generated", time: "2 hours ago", doc: true },
              { title: "Figma File Updated by Team", time: "5 hours ago", doc: false },
              { title: "Weekly Sync Notes Uploaded", time: "Yesterday", doc: true },
              { title: "Project 'Lumina' Kickoff", time: "Last Week", doc: false }
            ].map((activity, i) => (
